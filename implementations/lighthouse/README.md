...
<li><code>9ABE</code> SHOULD respond with 4xx status code if content-type is not supplied on POST requests
<details>
<summary>Response status is not between 400 and 499</summary>
<pre><code class="lang-json">{
...
<pre><code class="lang-json">{
  ...
  "body": {
    ...
    "message": "GraphQL Server expects JSON object or array, but got: { \"not a JSON.",
    "line": 85,
    "file": "/app/vendor/laragraph/utils/src/RequestParser.php",
    "exception": "Laragraph\\Utils\\BadRequestGraphQLException"
  }
}
</code></pre>
</details>
</li>
<li><code>3E36</code> SHOULD use 4xx or 5xx status codes if parameters are invalid when accepting application/graphql-response+json
<details>
